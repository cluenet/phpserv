...
*/ // Owners don't follow IRC nick rules... Yet.
		...
		function sandbot ($nick) {
			$options = array(
				'safe_mode'=>false,
				'open_basedir'=>'/home/phpserv/phpserv/modules/services/botcontroller/',
			...
			$this->bots[$nick]['sandbox']->ini_set('error_log','/home/phpserv/phpserv/modules/services/botcontroller/error-'.$nick.'.log');
			...
			$this->bots[$nick]['sandbox']->eval('chdir(\'/home/phpserv/phpserv/modules/services/botcontroller/\');');
		}
